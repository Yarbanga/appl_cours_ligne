...
<form class="mt-5 m-2" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row mb-1">
                            ...
                            <div class="col">
                                <input type="phone" class="form-control" name="tel" placeholder="Telephone" @error('tel') is-invalid @enderror value="{{ old('tel') }}" required>
                                @error('tel')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="row mb-1">
                            ...
                            <div class="col" >
                                <select name="pays" required class="form-control" id="exampleFormControlSelect1" required>
                                    <option value="Burkina_Faso" selected="selected">Burkina_Faso </option>
                    ...
                    <div class="row mb-1">
                            ...
                            <div class="col">
                                    <select name="classe" required class="form-control" id="exampleFormControlSelect1" required>
                                        ...
                                        <option value="7">6ième </option>
                                        <option value="8">5ième </option>
                                        <option value="9">4ième </option>
                                        <option value="10">3ième </option>
                                        <option value="11">2nd </option>
                                        <option value="12">1ère</option>
                                        <option value="13">Tle</option>
                                    </select>
                    ...
                    <div class="row mb-1">
                            ...
                            <div class="col">
                                <select class="form-control" id="exampleFormControlSelect1" @error('email') is-invalid @enderror value="{{ old('email') }}" required>
                                <option value="Genre" selected="selected">Choisir Genre</option>
